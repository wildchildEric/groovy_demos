...
class Heavy {
    ...
    Heavy() { println "Creating GroovyForJavaEyes.Heavy with $size" }
}
...
class AsNeeded {
    ...
    AsNeeded() { println "Created GroovyForJavaEyes.AsNeeded" }
}
...
println "Accessing GroovyForJavaEyes.TheUnique"
